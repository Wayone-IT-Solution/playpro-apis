...
import { placeOrder, getMyOrders, getOrderById, getAllOrders, getAllOrdersForAdmin, applyCoupon, removeCoupon, updateOrder } from "../order/order.controller";
...
router.post("/:id", authenticateToken, asyncHandler(updateOrder));
